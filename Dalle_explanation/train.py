...
def train_model(train_loader, val_loader, num_classes, num_epochs, learning_rate, step_size, gamma, model_choice, bias_type):
    ...
    checkpoint_dir = f'checkpoints/{bias_type}/{model_name}'
...
if __name__ == "__main__":
    ...
    train_model(train_loader, val_loader, num_classes, num_epochs, learning_rate, step_size, gamma, args.model, args.bias_type)
